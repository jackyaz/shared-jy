...
if(invalid_char != ""){
if(flag != "noalert")
alert("<#260#> ' "+invalid_char+" ' !");
string_obj.value = "";
string_obj.focus();
if(flag != "noalert")
return false;
else
return "<#260#> ' "+invalid_char+" ' !";
}
if(flag != "noalert")
return true;
else
...
document.getElementById("check_ip_input").innerHTML="<#252#>";
...
alert(document.form.wan_ipaddr_x.value + " <#252#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#238#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#257#> '+o.value.charAt(i)+' <#258#>');
o.focus();
o.select();
return false;
}
