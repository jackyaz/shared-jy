...
((B * 8) / 1000)
REMOVE-END */
return (byt / 1024 / 125).toFixed(2) + ' <small>Mbps</small>';
}
function showCTab()
{
...
var tabsort = ["speed-tab-INTERNET,<#1816#>", "speed-tab-INTERNET,<#1472#>","speed-tab-INTERNET1,<#1478#>","speed-tab-INTERNET,DSL WAN","speed-tab-INTERNET,WAN","speed-tab-INTERNET,WAN2","speed-tab-INTERNET,LAN","speed-tab-INTERNET,USB Modem","speed-tab-INTERNET,<#2124#>","speed-tab-INTERNET1,WAN","speed-tab-INTERNET1,WAN2","speed-tab-INTERNET1,LAN","speed-tab-INTERNET1,<#2124#>","speed-tab-INTERNET1,USB Modem","speed-tab-WIRED,<#2607#>", "speed-tab-LACP1,Bonding (LAN1)", "speed-tab-LACP2,Bonding (LAN2)", "speed-tab-LACP5,Bonding (LAN5)", "speed-tab-LACP6,Bonding (LAN6)", "speed-tab-WIRELESS0,<#2608#> (2.4GHz)","speed-tab-WIRELESS1,<#2608#> (5GHz)", "speed-tab-WIRELESS1,<#2608#> (5GHz-1)", "speed-tab-WIRELESS2,<#2608#> (5GHz-2)", "speed-tab-WIRELESS3,<#2608#> (60GHz)", "speed-tab-BRIDGE,LAN"];
var sortabs = [];
